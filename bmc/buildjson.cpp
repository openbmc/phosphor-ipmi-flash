        ...
        try
        {
            ...
            else
            {
                throw std::runtime_error(std::string(
                    "Invalid handler type: " + std::string(h.at("type"))));
            }
            ...
            else
            {
                throw std::runtime_error(
                    std::string("Invalid preparation type: " +
                                std::string(prep.at("type"))));
            }
            ...
            {
                throw std::runtime_error(
                    std::string("Invalid verification type:" +
                                std::string(verify.at("type"))));
            }
            ...
            else if (update.at("type") == "systemd")
            {
            ...
            {
                throw std::runtime_error(std::string(
                    "Invalid update type: " + std::string(update.at("type"))));
            }

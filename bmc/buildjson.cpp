        ...
        try
        {
            ...
            else
            {
                throw std::runtime_error(
                    std::string("Invalid handler type: " + handlerType));
            }
            ...
            {
                throw std::runtime_error(
                    std::string("Invalid preparation type: " + prepareType));
            }
            ...
            {
                throw std::runtime_error(
                    std::string("Invalid verification type:" + verifyType));
            }
            ...
            {
                throw std::runtime_error(
                    std::string("Invalid update type: " + updateType));
            }
